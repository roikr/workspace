		...
		*/
		...
		/*
  		 ...
  		 */
  		 ...
  		 public static function play(code:int,probability:Number=1.0) : void {
  		...
  		public static function chooseAndPlay(arr:Array,probability:Number=1.0) : void {
  			var index:int = Math.floor(Math.random()*arr.length);
  			play(arr[index],probability);
  		 }
